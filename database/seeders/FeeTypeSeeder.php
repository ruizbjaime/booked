...
class FeeTypeSeeder extends Seeder
{
    ...
    private function types(): array
    {
        return [
            ...
            ['name' => 'extra-guest-fee', 'en_name' => 'Extra Guest Fee', 'es_name' => 'Tarifa por huésped adicional', 'order' => 4],
            ...
            ['name' => 'management-fee', 'en_name' => 'Management Fee', 'es_name' => 'Tarifa de gestión', 'order' => 8],
            ...
            ['name' => 'tourism-fee', 'en_name' => 'Tourism Fee', 'es_name' => 'Tasa turística', 'order' => 13],
            ...
            ['name' => 'local-conservation-fee', 'en_name' => 'Local Conservation Fee', 'es_name' => 'Tasa local de conservación', 'order' => 21],
            ...
            ['name' => 'late-check-out-fee', 'en_name' => 'Late Check-out Fee', 'es_name' => 'Tarifa por salida tardía', 'order' => 30],
