...
class IdentificationDocumentTypeSeeder extends Seeder
{
    ...
    private function types(): array
    {
        return [
            ...
            ['code' => 'C.E.', 'en_name' => 'Foreign ID', 'es_name' => 'Cédula de Extranjería', 'sort_order' => 2],
            ['code' => 'T.I.', 'en_name' => 'Identity Card', 'es_name' => 'Tarjeta de Identidad', 'sort_order' => 3],
            ['code' => 'R.C.', 'en_name' => 'Birth Certificate', 'es_name' => 'Registro Civil de Nacimiento', 'sort_order' => 4],
            ['code' => 'PA', 'en_name' => 'Passport', 'es_name' => 'Pasaporte', 'sort_order' => 5],
            ['code' => 'NIT', 'en_name' => 'Tax ID', 'es_name' => 'NIT', 'sort_order' => 6],
