            ...
            <div class="flex items-center gap-3 sm:gap-5">
                ...
                <div class="min-w-0 space-y-1">
                    ...
                    <div class="flex items-center gap-2">
                        <flux:badge size="sm" color="zinc">{{ $this->feeType->slug }}</flux:badge>
                    </div>
                </div>
            </div>
        </x-show.panel>
            ...
            >
                ...
                @if ($editingSection === 'details')
                    <div class="space-y-4">
                        <flux:input
                            readonly
                            :value="$this->feeType->slug"
                            id="fee-type-show-slug"
                ...
                @else
                    <div class="grid gap-4 sm:grid-cols-2">
                        <x-show.detail-item :label="__('fee_types.show.fields.name')">
                            ...
                            <flux:text class="text-lg font-semibold text-zinc-900 dark:text-white">{{ $this->feeType->slug }}</flux:text>
                        </x-show.detail-item>
