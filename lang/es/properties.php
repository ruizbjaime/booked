...
return [
    ...
    'show' => [
        ...
        'accommodation' => [
            ...
            'bath_room_types' => [
                'title' => 'Tipos de baño',
                'empty' => 'Todavía no se han agregado tipos de baño a esta habitación.',
                'quantity_badge' => 'Cant.: :quantity',
                'created' => 'El tipo de baño ":bath_room_type" fue agregado correctamente a ":bedroom".',
                'fields' => [
                    'bath_room_type' => 'Tipo de baño',
                    'quantity' => 'Cantidad',
                ],
                'delete' => [
                    'action' => 'Quitar tipo de baño',
                    'aria_label' => 'Quitar tipo de baño :bath_room_type',
                    'title' => '¿Quitar tipo de baño?',
                    'message' => 'Está a punto de quitar el tipo de baño :bath_room_type de la habitación :bedroom. Esta acción elimina la asociación de la configuración de acomodación de esta propiedad.',
                    'confirm_label' => 'Quitar tipo de baño',
                    'deleted' => 'El tipo de baño :bath_room_type fue retirado correctamente de la habitación :bedroom.',
                ],
                'form' => [
                    'title' => 'Agregar tipo de baño',
                    'description' => 'Asocia un tipo de baño con la habitación ":bedroom".',
                    'submit' => 'Guardar tipo de baño',
                    'trigger' => 'Baño',
                ],
            ],
            'shared_bath_room_types' => [
                'title' => 'Baños compartidos',
                'description' => 'Tipos de baño disponibles para la propiedad fuera de una habitación específica.',
                'empty' => 'Todavía no se han agregado tipos de baño compartidos a esta propiedad.',
                'quantity_badge' => 'Cant.: :quantity',
                'created' => 'El tipo de baño compartido ":bath_room_type" fue agregado correctamente a ":property".',
                'fields' => [
                    'bath_room_type' => 'Tipo de baño',
                    'quantity' => 'Cantidad',
                ],
                'delete' => [
                    'action' => 'Quitar tipo de baño compartido',
                    'aria_label' => 'Quitar tipo de baño compartido :bath_room_type',
                    'title' => '¿Quitar tipo de baño compartido?',
                    'message' => 'Está a punto de quitar el tipo de baño compartido :bath_room_type de la propiedad :property. Esta acción elimina la asociación de baño compartido de esta propiedad.',
                    'confirm_label' => 'Quitar tipo de baño compartido',
                    'deleted' => 'El tipo de baño compartido :bath_room_type fue retirado correctamente de la propiedad :property.',
                ],
                'form' => [
                    'title' => 'Agregar tipo de baño compartido',
                    'description' => 'Asocia un tipo de baño compartido con la propiedad ":property".',
                    'submit' => 'Guardar tipo de baño compartido',
                    'trigger' => 'Baño',
                ],
            ],
        ],
