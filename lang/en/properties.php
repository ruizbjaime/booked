    ...
    'show' => [
        ...
        'accommodation' => [
            ...
            'bath_room_types' => [
                ...
                'empty' => 'No bathroom types have been added to this bedroom yet.',
                'quantity_badge' => 'Qty: :quantity',
                'created' => 'The bathroom type ":bath_room_type" was added to ":bedroom" successfully.',
                'fields' => [
                    'bath_room_type' => 'Bathroom type',
                    'quantity' => 'Quantity',
                ],
                'delete' => [
                    'action' => 'Remove bathroom type',
                    'aria_label' => 'Remove bathroom type :bath_room_type',
                    'title' => 'Remove bathroom type?',
                    'message' => 'You are about to remove the bathroom type :bath_room_type from bedroom :bedroom. This action removes the association from this property accommodation setup.',
                    'confirm_label' => 'Remove bathroom type',
                    'deleted' => 'The bathroom type :bath_room_type was removed from bedroom :bedroom successfully.',
                ],
                'form' => [
                    'title' => 'Add bathroom type',
                    'description' => 'Associate a bathroom type with the bedroom ":bedroom".',
                    'submit' => 'Save bathroom type',
                    'trigger' => 'Bathroom',
                ],
            ],
            'shared_bath_room_types' => [
                'title' => 'Shared bathrooms',
                'description' => 'Bathroom types available to the property outside of any single bedroom.',
                'empty' => 'No shared bathroom types have been added to this property yet.',
                'quantity_badge' => 'Qty: :quantity',
                'created' => 'The shared bathroom type ":bath_room_type" was added to ":property" successfully.',
                'fields' => [
                    'bath_room_type' => 'Bathroom type',
                    'quantity' => 'Quantity',
                ],
                'delete' => [
                    'action' => 'Remove shared bathroom type',
                    'aria_label' => 'Remove shared bathroom type :bath_room_type',
                    'title' => 'Remove shared bathroom type?',
                    'message' => 'You are about to remove the shared bathroom type :bath_room_type from property :property. This action removes the shared bathroom association from this property.',
                    'confirm_label' => 'Remove shared bathroom type',
                    'deleted' => 'The shared bathroom type :bath_room_type was removed from property :property successfully.',
                ],
                'form' => [
                    'title' => 'Add shared bathroom type',
                    'description' => 'Associate a shared bathroom type with the property ":property".',
                    'submit' => 'Save shared bathroom type',
                    'trigger' => 'Bathroom',
                ],
            ],
        ],
