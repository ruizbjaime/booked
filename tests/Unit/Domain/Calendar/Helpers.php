...
function allPricingRuleDefinitions(): array
{
    return [
        ...
        new PricingRuleData(11, 'high_impact_holiday', 2, 2, PricingRuleType::Holiday, ['min_impact' => 8], 8),
        ...
        new PricingRuleData(4, 'long_weekend_high_impact', 2, 2, PricingRuleType::HolidayBridge, ['is_bridge_weekend' => true, 'day_of_week' => ['thursday', 'friday', 'saturday', 'sunday'], 'min_impact' => 8], 10),
        new PricingRuleData(12, 'long_weekend_low_impact', 3, 3, PricingRuleType::HolidayBridge, ['is_bridge_weekend' => true, 'day_of_week' => ['thursday', 'friday', 'saturday', 'sunday'], 'max_impact' => 7], 11),
