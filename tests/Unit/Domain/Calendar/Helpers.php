...
function allPricingRuleDefinitions(): array
{
    return [
        ...
        new PricingRuleData(11, 'high_impact_holiday', 2, 2, PricingRuleType::Holiday, ['min_impact' => 8.0], 8),
        new PricingRuleData(10, 'bridge_first_day', 3, 3, PricingRuleType::HolidayBridge, ['is_bridge_weekend' => true, 'is_first_bridge_day' => true], 9),
        new PricingRuleData(4, 'long_weekend_high_impact', 2, 2, PricingRuleType::HolidayBridge, ['is_bridge_weekend' => true, 'day_of_week' => ['thursday', 'friday', 'saturday', 'sunday'], 'min_impact' => 8.0], 10),
        new PricingRuleData(12, 'long_weekend_low_impact', 3, 3, PricingRuleType::HolidayBridge, ['is_bridge_weekend' => true, 'day_of_week' => ['thursday', 'friday', 'saturday', 'sunday'], 'max_impact' => 7.9], 11),
        new PricingRuleData(6, 'holy_week_non_premium', 2, 2, PricingRuleType::SeasonDays, ['season_block_id' => 1, 'exclude_last_n_days' => 3], 13),
        new PricingRuleData(5, 'october_recess', 3, 3, PricingRuleType::SeasonDays, ['season_block_id' => 3], 12),
